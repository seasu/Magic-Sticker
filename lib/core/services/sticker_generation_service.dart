...
- 整個正方形畫布背景必須為純綠色（R=0, G=255, B=0, #00FF00），四個角落及所有背景區域均填滿純綠，不得有任何漸層或雜色
- 角色人物本身禁止使用任何綠色（green）系顏色，包含服裝、頭髮、裝飾等所有部位
...
【畫布規格 — Chroma Key 去背模式】
- 整個正方形畫布背景必須為純綠色（R=0, G=255, B=0, #00FF00），四個角落及所有背景區域均填滿純綠
- 角色人物本身禁止使用任何綠色（green）系顏色，包含服裝、頭髮、裝飾等所有部位
