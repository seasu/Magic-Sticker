...
- 角色頭頂保留至少 10% 的上邊距（確保頭部、耳朵、髮型完全不被截斷），雙腳或身體下緣保留至少 5% 的下邊距
- 角色左右兩側保留約 10% 邊距
...
- 表情 / 動作：${spec.emotion}
- ${style.characterDesc}
- 角色完整呈現於畫布中央，頭頂保留至少 10% 的上邊距（確保頭部、耳朵、髮型完全不被截斷），身體下緣保留至少 5% 的下邊距，左右各保留約 10% 邊距
- 嚴禁角色的任何部位（頭頂、耳朵、手臂、腳等）被畫布邊緣截斷
- 畫面內禁止出現任何文字或英文字母
  ...
  String _buildProSection(
    ...
    if (personFeatures != null && personFeatures.trim().isNotEmpty) {
      featureSection =
          ...
          '⚠️ 構圖硬性規則（特徵強化不得違反此規則）：角色必須「完整」顯示於畫布內——'
          '頭頂（含髮型）距上邊至少 10%，腳底距下邊至少 8%，左右各保留至少 10% 邊距。'
          '嚴禁任何身體部位（頭頂、耳朵、手臂、腳）被畫布邊緣截斷。\n';
    }
