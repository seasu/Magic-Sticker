...
| 版本 | 日期 | 摘要 |
|---|---|---|
| v3.13.43 | 2026-03-26 | **chore(ci-conflict-reduction)**：調整前一版 CI 修正範圍，移除 `dart-analyze` job 中非必要的 `actions/setup-python`，僅保留 Android/iOS icon 生成所需的 Python venv 流程，降低與主線 workflow 變動衝突機率。 |
